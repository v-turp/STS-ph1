...
public class ManageContacts$$ViewBinder<T extends com.score.sts.ManageContacts> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131296424, "field 'ivNetworkImage'");
    target.ivNetworkImage = finder.castView(view, 2131296424, "field 'ivNetworkImage'");
    ...
    view = finder.findRequiredView(source, 2131296422, "method 'uploadContent'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
